    ...
    with context('orakWlum_API'):
        with context('initialization'):
            with it('must be performed as expected'):
                with vcr.use_cassette('fixtures/okW_API_login.yaml'):
            ...
            with context('errors'):
                with it('must be handled for incorrect user'):
                    with vcr.use_cassette('fixtures/okW_API_error_login_incorrect_user.yaml'):
                ...
                with it('must be handled for incorrect password'):
                    with vcr.use_cassette('fixtures/okW_API_error_login_incorrect_passwd.yaml'):
        ...
        with context('consumption'):
            ...
            with it('must be performed as expected for GET requests'):
                with vcr.use_cassette('fixtures/okW_API_get.yaml'):
                    pass
